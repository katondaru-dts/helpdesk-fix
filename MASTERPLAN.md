...
│   │   └── Filters.php         # Registrasi filter auth, admin, ratelimiter, profilecomplete
│   ├── Controllers/
...
│   │       └── Settings.php    # Manajemen parameter dasar
│   ├── Models/
│   │   ├── UserModel.php
│   │   ├── TicketModel.php
│   │   ├── DepartmentModel.php
...
│   │   ├── RoleModel.php
│   │   ├── AuditLogModel.php
│   │   └── SettingModel.php    # Model data parameter dasar
│   ├── Filters/
│   │   ├── AuthFilter.php      # Cek status login
│   │   ├── AdminFilter.php     # Cek role admin
│   │   ├── RateLimiter.php     # Pembatas upaya login (5/menit)
│   │   └── ProfileCompleteFilter.php # Paksa kelengkapan profil (phone & gender)
│   ├── Views/
...
│   │   ├── profile/            # index.php & complete.php
│   │   ├── admin/
│   │   │   ├── users/
│   │   │   ├── departments/
│   │   │   ├── categories/
...
│   │   │   ├── reports/
│   │   │   ├── audit_logs/
│   │   │   └── settings/       # index.php parameter dasar
...
### Terproteksi (Perlu Login — Filter: `auth`, `profilecomplete` jika user_id=3)
| Method | URL | Fungsi |
|--------|-----|--------|
...
- [x] **Email Reply Sync** — Sinkronisasi balasan email ke tiket secara otomatis. User dapat membalas email notifikasi (balasan tiket, perubahan status) langsung dari Gmail/Outlook dan balasannya akan masuk ke percakapan tiket di aplikasi.
