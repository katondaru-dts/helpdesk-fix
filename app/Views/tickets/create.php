...
<div id="photoModal"
    style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.85);z-index:9999;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(6px)">
    <div
        style="background:white;border-radius:16px;max-width:580px;width:100%;box-shadow:0 25px 60px rgba(0,0,0,.5);animation:modalIn .25s ease-out;overflow:hidden">
        <!-- Header -->
        <div
            ...
            <button type="button" id="modalClose"
                style="background:none;border:none;font-size:24px;color:#9ca3af;cursor:pointer;padding:4px;line-height:1;transition:color .2s"
                onmouseover="this.style.color='#374151'" onmouseout="this.style.color='#9ca3af'">&times;</button>
        </div>
        <!-- Zoom Container -->
        <div style="padding:20px;text-align:center;background:#f3f4f6;position:relative;overflow:hidden;min-height:200px;cursor:grab;user-select:none"
            id="zoomContainer">
            <img id="modalPhotoPreview" alt="Preview Foto"
                style="max-width:100%;max-height:400px;border-radius:8px;display:inline-block;box-shadow:0 4px 12px rgba(0,0,0,.2);transform-origin:center center;touch-action:none">
            <!-- Zoom Controls -->
            <div
                style="position:absolute;bottom:14px;right:14px;display:flex;gap:4px;align-items:center;background:rgba(255,255,255,.92);padding:5px 10px;border-radius:10px;box-shadow:0 2px 10px rgba(0,0,0,.15)">
                <button type="button" id="zoomIn"
                    style="background:none;border:none;cursor:pointer;font-size:20px;font-weight:700;color:#374151;padding:0 6px;line-height:1;border-radius:4px"
                    title="Perbesar">+</button>
                <span id="zoomLevel"
                    style="font-size:12px;font-weight:600;color:#6b7280;min-width:36px;text-align:center">100%</span>
                ...
                <button type="button" id="zoomReset"
                    style="background:none;border:none;cursor:pointer;font-size:13px;color:#3b82f6;padding:0 4px;line-height:1;border-radius:4px;font-weight:600"
                    title="Reset zoom">Reset</button>
            </div>
        </div>
        <!-- Footer -->
        <div id="modalFooter"
            style="padding:14px 20px;border-top:1px solid #e5e7eb;display:flex;gap:10px;justify-content:flex-end;align-items:center">
            ...
            <button type="button" id="modalSubmit"
                style="display:none;padding:9px 22px;background:linear-gradient(135deg,#3b82f6,#2563eb);color:white;border:none;border-radius:8px;font-weight:700;cursor:pointer;font-size:13px;box-shadow:0 2px 8px rgba(59,130,246,.4)"><i
                    class="bi bi-send-fill"></i> Kirim Laporan</button>
        </div>
    </div>
</div>
